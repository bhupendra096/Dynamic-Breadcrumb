...
function tsh_wp_custom_breadcrumbs() {
    ...
    if ( !is_front_page() ) {
        ...
        if ( is_archive() && !is_tax() && !is_category() && !is_tag() ) {
            ...
            $c_tax_name = get_queried_object();
            if($post_type != 'post') {
                if($c_tax_name->taxonomy == "product_cat"){
...
//https://stackoverflow.com/questions/25708109/how-to-create-breadcrumbs-using-wordpress-nav-menu-without-plugin
